...
/* Message constants */
#define SHELL_BANNER "\033[1;35m       H E L L O\n     +-+-+-+-+-+-+\n S | A | U | G | A | T\n     +-+-+-+-+-+-+\033[0;39m\n"


/** start message */
     
#define SHELL_START     "Welcome to the wonderful world of SAUGAT!\n"
...
command xsh_semaphore1(ushort, ushort, ushort, ushort, char*[]); 
command xsh_semaphore2(ushort, ushort, ushort, ushort, char*[]);
command xsh_cyclic2(char[],ushort, ushort, ushort, ushort, char*[]);
#endif /* _SHELL_H_ */ 
